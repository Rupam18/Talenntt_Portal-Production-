    ...
    <div className="test-page-wrap">
          ...
          <Col lg={3}>
            <Card className="palette-card">
              <Card.Body>
                ...
                {sections.filter((_, index) => index === activeSection).map((section) => (
      ...
      >
        <Modal.Body className="text-center p-5">
          ...
          <h2 className="modal-title font-bold text-center">Submit Section?</h2>
        ...
        <Modal.Body className="text-center p-5">
          <div className="flex flex-col items-center justify-center mb-4">
            <div className="w-16 h-16 bg-danger/10 rounded-full flex items-center justify-center">
              <FaCheckCircle className="text-danger text-4xl" />
            </div>
          </div>
          <h2 className="modal-title font-bold text-center">Submit Test?</h2>
          <p className="confirm-description">
