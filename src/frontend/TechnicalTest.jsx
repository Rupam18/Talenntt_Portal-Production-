  ...
  const { violationCount, attemptsLeft } = useProctoring({
    ...
    onAutoSubmit: () => {
      setDialog({
        ...
        message: 'Security violation: Auto-submitting the test due to suspicious activity.',
        type: 'alert',
        onConfirm: () => {
  ...
  const showSubmitConfirmation = () => {
    ...
    if (answeredInSection === 0) {
      setDialog({
        show: true,
        title: 'Attention',
        message: 'Please answer at least one question before submitting the section.',
        type: 'alert',
  ...
  const showSubmitTestConfirmation = () => {
    ...
    if (totalAnswered === 0) {
      setDialog({
        show: true,
        title: 'Attention',
        message: 'Please answer at least one question before submitting the test.',
        type: 'alert',
        onConfirm: () => setDialog(prev => ({ ...prev, show: false }))
      });
      return
  ...
  const finalizeTestSubmission = async () => {
    ...
    try {
      ...
      setDialog({
        ...
        message: 'There was an error submitting your test. Please check your connection and try again.',
        type: 'warning',
        onConfirm: () => setDialog(prev => ({ ...prev, show: false }))
      });
    }
    ...
    <div className="test-page-wrap">
      ...
      <Modal show={showSubmitConfirmModal} centered backdrop="static" keyboard={false}>
        <Modal.Body className="text-center p-5">
          ...
          <div className="flex flex-col items-center justify-center mb-4 text-center">
            <div className="w-16 h-16 bg-warning/10 rounded-full flex items-center justify-center mb-2 text-warning">
              <FaCheckCircle className="text-4xl" />
            </div>
          </div>
          <div className="modal-actions d-flex justify-content-center gap-3">
      ...
      <Modal show={showSubmitTestConfirmModal} centered backdrop="static" keyboard={false} size="lg">
        <Modal.Header className="bg-danger text-white">
          <Modal.Title className="w-100 flex items-center justify-center gap-2 font-bold mb-0">
            <FaExclamationTriangle />
            <span>Submit Technical Test</span>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body className="text-center p-4">
          ...
          <div className="flex flex-col items-center justify-center mb-4 text-center">
            <div className="w-16 h-16 bg-warning/10 rounded-full flex items-center justify-center mb-2">
              <FaCheckCircle className="text-warning text-4xl" />
            </div>
          </div>
